...
export default function CardItem(props) {
    return (
        <Link to={'/item/' + props.content.id} className="card-item flex items-center gap-4 bg-white px-4 py-3 rounded-lg border border-dark-10 hover:outline hover:outline-3 hover:outline-primary-80">
