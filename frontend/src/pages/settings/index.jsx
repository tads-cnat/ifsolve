        ...
        <SidebarLayout>
            <div className="md:container py-5">
                ...
                <div className="mb-3">
                    ...
                    <button type='button' onClick={(e) => HandleLogout(e)} className="px-5 py-2 text-sm font-medium text-red-400 rounded-lg border-2 border-red-400 hover:bg-red-400 hover:text-white transition duration-300">Quero sair</button>
                </div>
            </div>
        </SidebarLayout>
    )
